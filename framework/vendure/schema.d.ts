...
export type Scalars = {
   ...
   *
   * Example value: `"https://johns-apparel.myvendure.com"`.
   *
   */
  URL: any
}
...
export type ApiVersion = {
  ...
  /** Whether the version is supported by Vendure. */
 ...
 * a Vendure vaulted credit card payment.
 */
export type CreditCardPaymentInput = {
  ...
  /** The ID returned by Vendure's Card Vault. */
...
/** Represents a video hosted outside of Vendure. */
...
export type Image = {
  ...
  /** The original height of the image in pixels. Returns `null` if the image is not hosted by Vendure. */
  ...
  /** The original width of the image in pixels. Returns `null` if the image is not hosted by Vendure. */
...
export enum MediaContentType {
  ...
  /** A Vendure hosted image. */
  Image = 'IMAGE',
  /** A 3d model. */
  Model_3D = 'MODEL_3D',
  /** A Vendure hosted video. */
  Video = 'VIDEO',
}
...
/** Represents a Vendure hosted image. */
...
/** Represents a Vendure hosted 3D model. */
...
/** Represents a source for a Vendure hosted 3d model. */
...
export type Mutation = {
  ...
  /**
   * Completes a checkout using a credit card token from Vendure's Vault.
  ...
  /** Completes a checkout using a credit card token from Vendure's card vault. Before you can complete checkouts using CheckoutCompleteWithCreditCardV2, you need to  [_request payment processing_](https://help.vendure.com/api/guides/sales-channel-sdk/getting-started#request-payment-processing). */
...
/** Vendure merchants can create pages to hold static HTML content. Each Page object represents a custom page on the online store. */
...
export type Payment = Node & {
  ...
  /** The actual transaction recorded by Vendure after having processed the payment with the gateway. */
...
export type PaymentSettings = {
  ...
  currencyCode: CurrencyCode
  /** A list of enabled currencies (ISO 4217 format) that the shop accepts. Merchants can enable currencies from their Vendure Payments settings in the Vendure admin. */
  enabledPresentmentCurrencies: Array<CurrencyCode>
  /** The shop’s Vendure Payments account id. */
  vendurePaymentsAccountId?: Maybe<Scalars['String']>
...
/**
 * A product represents an individual item for sale in a Vendure store. Products are often physical, but they don't have to be.
...
export type QueryRoot = {
   ...
   * [*Showing product recommendations on product pages*](https://help.vendure.com/themes/development/recommended-products).
   */
 ...
 * was created by a Vendure Script.
 */
...
/** Represents a Vendure hosted video. */
...
/** Represents a source for a Vendure hosted video. */
